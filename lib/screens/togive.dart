...
import 'package:Personal_Wallet/screens/toadd1.dart';
...
class Togive extends StatefulWidget {
  ...
  Togive({this.gCurrentUser});
  @override
  _TogiveState createState() => _TogiveState();
}

class _TogiveState extends State<Togive> {
  int notecount = 0;
  bool loading = true;
  String postOrientation = "grid";
  List<Post> postsList1 = [];
  void initState() {
    super.initState();
          ...
          onPressed: () {
            ...
            Navigator.push(
                ...
                new MaterialPageRoute(
                    builder: (context) =>
                        AddUserPay1(gCurrentUser: widget.gCurrentUser)));
          },
  ...
  getAllProfilePosts() async {
    ...
    QuerySnapshot querySnapshot = await postsReference1
    ...
    setState(() {
      ...
      print(notecount);
      postsList1 = querySnapshot.documents
